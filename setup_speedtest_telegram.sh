...
install_speedtest() {
    if ! command -v speedtest &> /dev/null || ! speedtest --version | grep -q "Speedtest by Ookla"; then
        ...
        # Подтверждаем условия использования только при первой установке
...
echo -e "🌐 Быстрый VPS-хостинг с бонусом +15% при пополнении!"
...
echo -e "\n🟦===================== [ ☕ ЧАЕВЫЕ ] ====================="
echo -e "💖 Поддержите проект чаевыми!"
echo -e "🔗 Ссылка: \e[1;34mhttps://pay.cloudtips.ru/p/7410814f\e[0m"
